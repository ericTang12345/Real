...
class FirstPageViewController: BaseViewController {
    ...
    @IBOutlet weak var signinWithAppleButton: CustomizeButton! {
        
        didSet {
            
            signinWithAppleButton.setup(cornerRadius: 20)
        }
    }
    ...
    @IBOutlet weak var visitorButton: UIButton! {
        ...
        didSet {
            ...
            visitorButton.setup(cornerRadius: 20)
        }
    }
    ...
    @IBAction func visitorEnter(_ sender: UIButton) {
        
        present(homePage, animated: true, completion: nil)
    }
    
    @IBAction func showPrivacyAndEula(_ sender: UIButton) {
...
//                    UserDefaults.standard.remove(forKey: .userID)
                    ...
                    self.present(self.homePage, animated: true) {
...
extension FirstPageViewController: ASAuthorizationControllerPresentationContextProviding {
